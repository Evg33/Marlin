...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 8*60, 5*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
//#define FWRETRACT
  ...
  #endif
  #define RETRACT_LENGTH 6 //3            // (mm) Default retract length (positive value)
