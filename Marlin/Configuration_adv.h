...
#define FWRETRACT
  ...
  #endif
  #define RETRACT_LENGTH 2 //3                // (mm) Default retract length (positive value)
  ...
  #define RETRACT_RECOVER_FEEDRATE 30 //8      // (mm/s) Default feedrate for recovering from retraction
...
//    #define E0_CURRENT   (2000*65/100)
  ...
  #define X_HYBRID_THRESHOLD     200 //90 //105  // [mm/s]
  #define X2_HYBRID_THRESHOLD    100
  #define Y_HYBRID_THRESHOLD     200 //90 //105
  ...
  #define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #define X_STALL_SENSITIVITY  165 //8
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    #define Y_STALL_SENSITIVITY  165 //8
