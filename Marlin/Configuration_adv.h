...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      640  //550  // (mm) The length of filament for a complete unload.  // 680 mosq
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH   600  //470  // (mm) Load length of filament, from extruder gear to nozzle. // 640 mosq
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
